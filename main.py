...
if __name__ == "__main__":
    ...
    dns_zone = DNSZone(
        logger, credential["zone_identifier"], 
        credential["email_account"], credential["api_token"]
    )
    ...
    www_khanhpham_uk_record = DNSRecord(
        name="www.khanhpham.uk", record_type="A",
        content=current_public_ip, proxied=False,
        ttl=3600, comment="www.khanhpham.us"
    )
